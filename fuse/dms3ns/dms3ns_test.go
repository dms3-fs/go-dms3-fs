...
import (
    ...
    racedet "github.com/dms3-fs/go-detect-race"
...
func setupDms3NsTest(t *testing.T, node *core.Dms3FsNode) (*core.Dms3FsNode, *mountWrap) {
...
func TestDms3NsLocalLink(t *testing.T) {
	nd, mnt := setupDms3NsTest(t, nil)
	defer mnt.Close()
	name := mnt.Dir + "/local"
...
func TestDms3NsBasicIO(t *testing.T) {
	if testing.Short() {
		t.SkipNow()
	}
	nd, mnt := setupDms3NsTest(t, nil)
...
// Test to make sure file changes persist over mounts of dms3ns
func TestFilePersistence(t *testing.T) {
	if testing.Short() {
		t.SkipNow()
	}
	node, mnt := setupDms3NsTest(t, nil)
